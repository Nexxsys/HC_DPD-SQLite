...
CREATE TABLE "drug" ("DRUG_CODE" INTEGER(8) PRIMARY KEY  NOT NULL , "PRODUCT_CATEGORIZATION" VARCHAR2(80), "CLASS" VARCHAR2(40), "DRUG_IDENTIFICATION_NUMBER" VARCHAR2(8), "BRAND_NAME" VARCHAR2(200), "DESCRIPTOR" VARCHAR2(150), "PEDIATRIC_FLAG" VARCHAR2(1), "ACCESSION_NUMBER" VARCHAR2(5), "NUMBER_OF_AIS" VARCHAR2(10), "LAST_UPDATE_DATE" DATE, "AI_GROUP_NO" VARCHAR2(10));
